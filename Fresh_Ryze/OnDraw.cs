        ...
        public static void Drawing_OnDraw(EventArgs args)
        {
            ...
            if (MainMenu._MainMenu.Item("DisplayStack").GetValue<bool>())
            {
                if (OnUpdate.Ryzepassivecharged != null)
                {
                    ...
                    Drawing.DrawText(RyzePosition[0]-30, RyzePosition[1]+15, DisColor, "Charge End: " + "{0:#.##}",end);
                }
            ...
            {                
                ...
                Drawing.DrawText(RyzeEndTime[0] - 30, RyzeEndTime[1] + 30, DisColor, "Passive End: " + "{0:#.##}",PassiveEnd);
            }
        }
    }
}
